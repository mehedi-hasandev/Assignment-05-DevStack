...
const TechCard: React.FC<TechCardProps> = ({ tech, onAddToStack, isAdded }) => {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between h-full">
      ...
      <div>
        {/* Meta Bar: Category | Difficulty | Rating */}
        <div className="flex items-center justify-between text-xs text-gray-500 mb-4 pt-1">
          ...
          {/* Difficulty (Plain Text in center) */}
        ...
        <button
          ...
          className={`w-full py-2.5 px-4 rounded-lg text-xs sm:text-sm font-medium transition-all ${
            isAdded
              ...
              : 'bg-slate-950 hover:bg-slate-900 text-white active:scale-[0.99] cursor-pointer'
          }`}
        >
